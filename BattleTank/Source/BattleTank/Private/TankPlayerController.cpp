...
bool ATankPlayerController::GetSightRayHitLocation(FVector& OutHitLocation) const
{
	...
	int32 ViewportSixeX, ViewportSizeY;
	GetViewportSize(ViewportSixeX, ViewportSizeY);
	auto ScreenLocation = FVector2D(ViewportSixeX * CrossHairXLocation, ViewportSizeY * CrossHairYLocation);
